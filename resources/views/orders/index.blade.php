...
@section('title', Auth::user()->isGestionnaire() ? 'Tableau de bord - Commandes' : 'Suivi de commandes')
    ...
    <div class="container-fluid px-4 py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                ...
                {{ Auth::user()->isGestionnaire() ? 'Tableau de bord des commandes' : 'Suivi de mes commandes' }}
            </h1>

            @if(!Auth::user()->isGestionnaire())
                <a href="{{ route('burgers.catalog') }}" class="btn btn-primary rounded-pill">
            ...
            <div class="row g-4 mb-5">
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100 overflow-hidden">
                        <div class="card-body position-relative">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 display-5">{{ $orders->where('status', 'en_attente')->count() }}</h2>
                                </div>
                        ...
                        <a href="{{ route('orders.index', ['status' => 'en_attente']) }}" class="text-decoration-none">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100 overflow-hidden">
                        <div class="card-body position-relative">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 display-5">{{ $orders->where('status', 'en_preparation')->count() }}</h2>
                                </div>
                        ...
                        <a href="{{ route('orders.index', ['status' => 'en_preparation']) }}" class="text-decoration-none">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100 overflow-hidden">
                        <div class="card-body position-relative">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 display-5">{{ $orders->where('status', 'prete')->count() }}</h2>
                                </div>
                        ...
                        <a href="{{ route('orders.index', ['status' => 'prete']) }}" class="text-decoration-none">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card border-0 shadow-sm h-100 overflow-hidden">
                        <div class="card-body position-relative">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h2 class="mb-0 display-5">{{ $orders->where('status', 'payee')->count() }}</h2>
                                </div>
                        ...
                        <a href="{{ route('orders.index', ['status' => 'payee']) }}" class="text-decoration-none">
                    ...
                    <form action="{{ route('orders.index') }}" method="GET" class="row g-3 align-items-end">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select name="status" id="status" class="form-select rounded-pill">
                                ...
                                <option value="prete" {{ request('status') === 'prete' ? 'selected' : '' }}>Prêtes</option>
                                <option value="payee" {{ request('status') === 'payee' ? 'selected' : '' }}>Payées</option>
                            </select>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <label for="date" class="form-label text-muted small text-uppercase">Date</label>
                            <input type="date" name="date" id="date" class="form-control rounded-pill" value="{{ request('date') }}">
                        </div>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                @if(Auth::user()->isGestionnaire() && $order->status === 'prete')
                                                    <li>
                                                        <a href="{{ route('payments.create', $order) }}" class="dropdown-item">
                                                ...
                                                @if($order->status === 'prete' || $order->status === 'payee')
                                                    <li>
                                                        <a href="{{ route('orders.invoice', $order) }}" class="dropdown-item">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body py-5">
                    <div class="text-center">
                        <img src="{{ asset('images/empty-orders.svg') }}" alt="Aucune commande" class="img-fluid mb-3" style="max-height: 200px;">
                        ...
                        @if(!Auth::user()->isGestionnaire())
                            <a href="{{ route('burgers.catalog') }}" class="btn btn-primary rounded-pill mt-3">
