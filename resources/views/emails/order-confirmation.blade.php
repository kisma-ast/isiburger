...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="order-info">
            <p class="order-title">Récapitulatif de la commande #{{ $order->id }} :</p>
            <ul class="order-items">
                @foreach($order->items as $item)
                    <li>{{ $item->quantity }}x {{ $item->burger->name }} - {{ number_format($item->price, 2) }} €</li>
                @endforeach
            </ul>
        ...
        <div class="button-container">
            <a href="{{ url('/orders/' . $order->id) }}" class="button">Suivre ma commande</a>
        </div>
