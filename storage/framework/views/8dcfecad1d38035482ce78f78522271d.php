        ...
        <div class="card mb-4 border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h1 class="fs-3 mb-0">Commande #<?php echo e($order->id); ?></h1>
                            <div class="text-muted">
                                <?php echo e($order->created_at->format('d/m/Y H:i')); ?> • <?php echo e($order->user->name); ?>
                    ...
                    <div class="mt-3 mt-md-0">
                        ...
                        <?php if($order->status === 'prete' || $order->status === 'payee'): ?>
                            <a href="<?php echo e(route('orders.invoice', $order)); ?>" class="btn btn-primary ms-2">
            ...
            <div class="order-progress">
                <div class="progress-line">
                    <div class="progress-step <?php echo e(in_array($order->status, ['en_attente', 'en_preparation', 'prete', 'payee']) ? 'completed' : ''); ?>">
                        <div class="step-icon"><i class="fas fa-receipt"></i></div>
                        <div class="step-label">Reçue</div>
                    </div>
                    <div class="progress-step <?php echo e(in_array($order->status, ['en_preparation', 'prete', 'payee']) ? 'completed' : ''); ?>">
                        <div class="step-icon"><i class="fas fa-utensils"></i></div>
                        <div class="step-label">En préparation</div>
                    </div>
                    <div class="progress-step <?php echo e(in_array($order->status, ['prete', 'payee']) ? 'completed' : ''); ?>">
                        <div class="step-icon"><i class="fas fa-check-circle"></i></div>
                        <div class="step-label">Prête</div>
                    </div>
                    <div class="progress-step <?php echo e($order->status === 'payee' ? 'completed' : ''); ?>">
                                    ...
                                    <tr>
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center">
                                                <?php if($item->burger && $item->burger->image): ?>
                                                    <div class="rounded overflow-hidden me-3">
                                                        <img src="<?php echo e(asset('storage/' . $item->burger->image)); ?>" alt="<?php echo e($item->burger->name); ?>" class="product-img">
                                                    </div>
                                                <?php else: ?>
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <h6 class="mb-0"><?php echo e($item->burger ? $item->burger->name : 'Burger indisponible'); ?></h6>
                                                    <?php if($item->burger && $item->burger->description): ?>
                                                        <small class="text-muted d-block"><?php echo e(Str::limit($item->burger->description, 50)); ?></small>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark rounded-pill px-3 py-2"><?php echo e($item->quantity); ?></span>
                                        </td>
                                        <td class="text-end pe-4 fw-semibold"><?php echo e(number_format($item->price * $item->quantity, 2)); ?> CFA</td>
                                    </tr>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-6">
                                    <div class="d-flex justify-content-between py-2">
                                        <span>Total HT</span>
                                        <span><?php echo e(number_format($order->total_amount / 1.2, 2)); ?> CFA</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-2">
                                        <span>TVA (20%)</span>
                                        <span><?php echo e(number_format($order->total_amount - ($order->total_amount / 1.2), 2)); ?> CFA</span>
                                    </div>
                                    <div class="d-flex justify-content-between py-2 border-top mt-2 pt-2">
                                        <span class="fw-bold">Total TTC</span>
                                        <span class="fw-bold fs-5"><?php echo e(number_format($order->total_amount, 2)); ?> CFA</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item px-0 py-3 d-flex justify-content-between">
                                ...
                                <span class="fw-medium"><?php echo e($order->created_at->format('d/m/Y H:i')); ?></span>
                            </li>
                            <li class="list-group-item px-0 py-3 d-flex justify-content-between">
                                <span class="text-muted"><i class="far fa-user me-2"></i>Client</span>
                                <span class="fw-medium"><?php echo e($order->user->name); ?></span>
                            </li>
                            <li class="list-group-item px-0 py-3 d-flex justify-content-between">
                                ...
                                <?php switch($order->status):
                                    ...
                                    <?php case ('payee'): ?>
                                        ...
                                        <?php break; ?>
                                    <?php default: ?>
                                        <span class="badge bg-secondary rounded-pill px-3 py-2"><?php echo e($order->status); ?></span>
                                <?php endswitch; ?>
                            </li>
                            <?php if($order->payment): ?>
                                <li class="list-group-item px-0 py-3 d-flex justify-content-between">
                                    <span class="text-muted"><i class="far fa-clock me-2"></i>Date de paiement</span>
                                    <span class="fw-medium"><?php echo e($order->payment->created_at->format('d/m/Y H:i')); ?></span>
                                </li>
                                <li class="list-group-item px-0 py-3 d-flex justify-content-between">
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <?php if($order->status !== 'payee'): ?>
                                <form action="<?php echo e(route('orders.status.update', $order)); ?>" method="POST" class="mb-3">
                                    <?php echo csrf_field(); ?>
                                ...
                                <?php if($order->status === 'prete' && !$order->payment): ?>
                                    <a href="<?php echo e(route('payments.create', $order)); ?>" class="btn btn-success btn-lg w-100 mb-3">
                            ...
                            <?php else: ?>
                                <div class="alert alert-success d-flex align-items-center shadow-sm border-0">
                                    ...
                                    <div>
                                        ...
                                        <div>Le <?php echo e($order->payment->created_at->format('d/m/Y à H:i')); ?></div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\isi-burger\resources\views/orders/show.blade.php ENDPATH**/ ?>