...
<head>
    ...
    <title>Modifier le burger - <?php echo e($burger->name); ?></title>
        ...
        <div class="col-md-8">
            <div class="burger-form">
                <div class="form-header">
                    ...
                    <p class="mb-0 mt-2 opacity-75"><?php echo e($burger->name); ?></p>
                </div>

                <div class="form-content">
                    <form action="<?php echo e(route('burgers.update', $burger)); ?>" method="POST" enctype="multipart/form-data" id="burgerForm">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>

                        <div class="mb-4">
                            <label for="name" class="custom-label required">Nom du burger</label>
                            <input type="text" class="form-control custom-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                                   id="name" name="name" value="<?php echo e(old('name', $burger->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="price-input-group">
                                <input type="number" step="50" min="0" class="form-control custom-input <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       id="price" name="price" value="<?php echo e(old('price', $burger->price)); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="stock-controls">
                                ...
                                <input type="number" min="0" class="form-control custom-input stock-input <?php $__errorArgs = ['stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       id="stock" name="stock" value="<?php echo e(old('stock', $burger->stock)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control custom-input <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      id="description" name="description" rows="3"><?php echo e(old('description', $burger->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="preview-container" id="imagePreviewContainer">
                                <?php if($burger->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $burger->image)); ?>" alt="<?php echo e($burger->name); ?>"
                            ...
                            <input type="file" class="form-control custom-input <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <a href="<?php echo e(route('burgers.index')); ?>" class="btn btn-burger-secondary">
...
<?php /**PATH C:\laragon\www\isi-burger\resources\views/burgers/edit.blade.php ENDPATH**/ ?>