...
<?php $__env->startSection('title', $burger->name); ?>

<?php $__env->startSection('content'); ?>
    <div class="container py-4">
        <div class="mb-4">
            <a href="<?php echo e(Auth::check() && Auth::user()->isGestionnaire() ? route('burgers.index') : route('burgers.catalog')); ?>" class="btn btn-outline-secondary rounded-pill shadow-sm">
            ...
            <div class="col-md-5">
                <div class="card border-0 rounded-4 shadow overflow-hidden mb-4">
                    <div class="position-relative">
                        ...
                        <?php if($burger->image): ?>
                            <img src="<?php echo e(asset('storage/' . $burger->image)); ?>" alt="<?php echo e($burger->name); ?>" class="img-fluid w-100" style="height: 250px; object-fit: cover;">
                        <?php else: ?>
                    ...
                    <div class="card-body text-center">
                        <h2 class="fw-bold mb-2"><?php echo e($burger->name); ?></h2>
                        <div class="d-flex justify-content-center align-items-center gap-2 mb-3">
                            <h3 class="text-primary fw-bold mb-0"><?php echo e(number_format($burger->price, 2)); ?> CFA</h3>
                            <?php if(!$burger->is_archived && $burger->stock > 0): ?>
                        ...
                        <?php else: ?>
                            <div class="alert alert-success border-start border-success border-4 shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="mb-0">Disponible en stock : <strong><?php echo e($burger->stock); ?></strong> unités</p>
                                </div>
                            </div>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="mt-4">
                                    ...
                                    <div class="input-group shadow-sm">
                                        ...
                                        <input type="number" name="quantity" value="1" min="1" max="<?php echo e($burger->stock); ?>" class="form-control border-0 text-center fw-bold">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary shadow-sm rounded-pill mt-4 w-100 py-2">
            ...
            <div class="col-md-7">
                ...
                <div class="card border-0 rounded-4 shadow mb-4">
                    ...
                    <div class="card-body pt-3">
                        <?php if($burger->description): ?>
                            <p class="mb-0 lead"><?php echo e($burger->description); ?></p>
                        <?php else: ?>
                        ...
                        <div class="row g-3 text-center">
                            <div class="col-3">
                                <div class="py-3 rounded-3 bg-light">
                                    ...
                                    <div class="h5 mb-0"><?php echo e(rand(200, 600)); ?></div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="py-3 rounded-3 bg-light">
                                    <div class="fw-bold text-primary mb-1">Protéines</div>
                                    <div class="h5 mb-0"><?php echo e(rand(20, 40)); ?>g</div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="py-3 rounded-3 bg-light">
                                    <div class="fw-bold text-primary mb-1">Glucides</div>
                                    <div class="h5 mb-0"><?php echo e(rand(30, 70)); ?>g</div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="py-3 rounded-3 bg-light">
                                    <div class="fw-bold text-primary mb-1">Lipides</div>
                                    <div class="h5 mb-0"><?php echo e(rand(10, 40)); ?>g</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php if(Auth::check() && Auth::user()->isGestionnaire()): ?>
                    <div class="card border-0 rounded-4 shadow mb-4">
                        <div class="card-header bg-transparent border-bottom-0 pt-4 pb-0 px-4">
                            <h4 class="fw-bold text-primary mb-0">
                        ...
                        <div class="card-body pt-3">
                            <div class="d-flex flex-wrap gap-2">
                                <a href="<?php echo e(route('burgers.edit', $burger)); ?>" class="btn btn-primary rounded-pill shadow-sm">
                                    <i class="fas fa-edit me-2"></i> Modifier
                                </a>

                                <?php if(!$burger->is_archived): ?>
                                    <form action="<?php echo e(route('burgers.archive', $burger)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('burgers.destroy', $burger)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\isi-burger\resources\views/burgers/show.blade.php ENDPATH**/ ?>