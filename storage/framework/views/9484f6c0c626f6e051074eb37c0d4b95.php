...
<head>
    ...
    <title>ISI BURGER - <?php echo $__env->yieldContent('title', 'Accueil'); ?></title>
...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm sticky-top">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(route('burgers.catalog')); ?>">|S|BURGER</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('burgers.catalog')); ?>">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php if(Auth::user()->isGestionnaire()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('burgers.index')); ?>">
            ...
            <ul class="navbar-nav">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i> Tableau de bord</a></li>
                ...
                <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('login')); ?>"><i class="fas fa-sign-in-alt me-1"></i> Connexion</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-primary ms-2" href="<?php echo e(route('register')); ?>"><i class="fas fa-user-plus me-1"></i> Inscription</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
...
<?php /**PATH C:\laragon\www\isi-burger\resources\views/layouts/app.blade.php ENDPATH**/ ?>